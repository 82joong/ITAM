...
class Service_manage_tb_model extends MY_Model
{

    protected $pk = 'sm_id';

    protected $emptycheck_keys = array(
        'sm_assets_model_id' => 'assets_model_id 값이 누락되었습니다.',
    );
    ...
    {
        $params['sm_created_at'] = date('Y-m-d H:i:s');
        $params['sm_updated_at'] = date('Y-m-d H:i:s');
        $params = $this->common->calAssetLevel($params);
        return $params;
    }
