<?php
require_once realpath(dirname(__FILE__)).'/config.ui.php';
?>
                <!-- BEGIN Left Aside -->
                <aside class="page-sidebar">
                    <div class="page-logo">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            ...
                            <span class="page-logo-text mr-1">Default Project WebApp</span>
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <div class="info-card">
                            <img src="/shop_assets/img/demo/avatars/avatar-admin.png" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
                            ...
                            <img src="/shop_assets/img/card-backgrounds/cover-2-lg.png" class="cover" alt="cover">
					...
					<?php
						foreach ($page_nav as $key => $nav_item) {
                            ...
                            */
							...
							$nav_htm .= '<a href="'.$url.'" '.$url_target.' title="'.$nav_title.'">'.$icon.' <span class="nav-link-text">'.$nav_title.'</span></a>';
								...
								foreach ($nav_item as $key => $sub_item) {
									...
									$sub_item_htm .= 
										'<li '.(isset($sub_item["active"]) ? 'class = "active '.$open.'"' : '').'>
											<a href="'.$url.'" '.$url_target.'>'.$icon.' <span class="nav-link-text">'.$nav_title.'</span></a>
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="/shop_assets/img/demo/avatars/avatar-admin.png" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                            </span>
                                            <div class="info-card-text">
                                    ...
                                    <div class="dropdown-divider m-0"></div>
                                    <a class="dropdown-item fw-500 pt-3 pb-3" href="/account/login">
