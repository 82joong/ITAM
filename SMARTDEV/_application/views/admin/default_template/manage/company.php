            ...
            <div class="panel">
                <div class="panel-hdr">
                    ...
                    <div class="panel-toolbar">
                        <a href="/<?=SHOP_INFO_ADMIN_DIR?>/manage/company_detail" class="btn btn-sm btn-success waves-effect waves-themed">
                    ...
                    <div class="panel-content">
                        ...
                        <table id="data-table" class="table table-sm table-striped table-bordered table-hover" style="width:100%">
                            <thead class="bg-warning-200">
                                <tr>
                                    <th class="width-10" data-name="c_id" data-type="text" data-op="eq">ID</th>
                                    <th data-name="c_code" data-type="text" data-op="eq">Code</th>
                                    <th data-name="c_name" data-type="text" data-op="cn">Name</th>
                                    <th data-name="c_img" data-type="none" >Image</th>
                                    <th data-name="c_tel" data-type="text" data-op="eq">Tel.</th>
                                    <th data-name="c_biz_number" data-type="text" data-op="eq">Biz No.</th>
                                    <th data-name="c_biz_owner" data-type="text" data-op="cn">Owner</th>
                                    <th data-name="c_is_active" data-type="select" data-value="<?=$active_data?>" data-op="eq">IsActive</th>
...
$(document).ready(function() {
    ...
    var table = $('#data-table').DataTable({
        ...
        "ajax": {
            "url": "/<?=SHOP_INFO_ADMIN_DIR?>/manage/company",
            "type": "POST",
            "dataType": "JSON",
            "data": {
                "mode": "list",
        ...
        "columnDefs": [
            { "className": "text-center fs-nano", "targets": [0,1,2,3,4,5,6,7] },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    var btn_act = '';
                    var base_url = '/<?=SHOP_INFO_ADMIN_DIR?>/manage/company_detail';

                    // Edit/Detail 
                    btn_act += dtEditButton(base_url+'/'+data.c_id);
                    // Delete 
                    btn_act += dtDeleteButton('javascript:delRow('+data.c_id+');');
                    return btn_act;
                }
            }
        ],
...
function delRow(id) {
    Swal.fire({
        ...
        if (result.value) {
            var url = '/<?=SHOP_INFO_ADMIN_DIR?>/manage/company_process';
            var params = {'c_id':id, 'mode':'delete'};
