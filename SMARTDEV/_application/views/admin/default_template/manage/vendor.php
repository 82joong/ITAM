            ...
            <div class="panel">
                <div class="panel-hdr">
                    ...
                    <div class="panel-toolbar">
                        <a href="/<?=SHOP_INFO_ADMIN_DIR?>/manage/vendor_detail" class="btn btn-sm btn-success waves-effect waves-themed">
                    ...
                    <div class="panel-content">
                        ...
                        <table id="data-table" class="table table-sm table-striped table-bordered table-hover" style="width:100%">
                            <thead class="bg-warning-200">
                                <tr>
                                    <th class="width-10" data-name="vd_id" data-type="text" data-op="eq">ID</th>
                                    <th data-name="vd_name" data-type="text" data-op="cn">Name</th>
                                    <th data-name="vd_img" data-type="None" >Image</th>
                                    <th data-name="vd_url" data-type="text" data-op="cn">URL</th>
                                    <th data-name="vd_support_url" data-type="text" data-op="cn">Support URL</th>
                                    <th data-name="vd_support_tel" data-type="text" data-op="eq">Support Tel.</th>
                                    <th data-name="vd_support_email" data-type="text" data-op="cn">Support Email</th>
...
$(document).ready(function() {
    ...
    var table = $('#data-table').DataTable({
        ...
        "ajax": {
            "url": "/<?=SHOP_INFO_ADMIN_DIR?>/manage/vendor",
            "type": "POST",
            "dataType": "JSON",
            "data": {
                "mode": "list",
        ...
        "columnDefs": [
            { "className": "text-center fs-nano", "targets": [0,1,2,5,6] },
            { "className": "text-left fs-nano", "targets": [3,4] },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    var btn_act = ''; 
                    var base_url = '/<?=SHOP_INFO_ADMIN_DIR?>/manage/vendor_detail';

                    // Edit/Detail 
                    btn_act += dtEditButton(base_url+'/'+data.vd_id);
                    // Delete 
                    btn_act += dtDeleteButton('javascript:delRow('+data.vd_id+');');
                    return btn_act;
                }
            }
        ],
...
function delRow(id) {
    Swal.fire({
        ...
        if (result.value) {
            var url = '/<?=SHOP_INFO_ADMIN_DIR?>/manage/vendor_process';
            var params = {'vd_id':id, 'mode':'delete'};
