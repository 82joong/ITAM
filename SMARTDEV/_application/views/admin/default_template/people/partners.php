            ...
            <div class="panel">
                <div class="panel-hdr">
                    ...
                    <div class="panel-toolbar">
                        <a href="/<?=SHOP_INFO_ADMIN_DIR?>/people/partner_detail" class="btn btn-sm btn-success waves-effect waves-themed">
                    ...
                    <div class="panel-content">
                        ...
                        <table id="data-table" class="table table-sm table-striped table-bordered table-hover" style="width:100%">
                            <thead class="bg-warning-200">
                                <tr>
                                    <th class="width-10" data-name="pt_id" data-type="text" data-op="eq">ID</th>
                                    <th data-name="pt_name" data-type="text" data-op="cn">name</th>
                                    <th data-name="pt_title" data-type="text" data-op="cn">Title</th>
                                    <th data-name="pt_dept" data-type="text" data-op="cn">Department</th>
                                    <th data-name="pt_email" data-type="text" data-op="cn">Email</th>
                                    <th data-name="pt_tel" data-type="text" data-op="eq">Tel</th>
                                    <th data-name="pt_mobile" data-type="text" data-op="eq">Mobile</th>
                                    <th data-name="pt_supplier_id" data-type="select" data-value="<?=$supplier_data?>" data-op="eq">Supplier</th>
...
$(document).ready(function() {
    ...
    var table = $('#data-table').DataTable({
        ...
        "ajax": {
            "url": "/<?=SHOP_INFO_ADMIN_DIR?>/people/partners",
            "type": "POST",
            "dataType": "JSON",
            "data": {
                "mode": "list",
        ...
        "columnDefs": [
            { "className": "text-center fs-nano", "targets": "_all" },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    var btn_act = ''; 
                    var base_url = '/<?=SHOP_INFO_ADMIN_DIR?>/people/partner_detail';

                    // Edit/Detail 
                    btn_act += dtEditButton(base_url+'/'+data.pt_id);
