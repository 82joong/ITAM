                        ...
                        <table id="data-table" class="table table-sm table-striped table-bordered table-hover" style="width:100%">
                            <thead class="bg-warning-200">
                                <tr>
                                    ...
                                    <th data-name="connect_tag" data-type="select" data-value="<?=$tag_map?>" data-op="eq" style="min-width:50px;">TYPE</th>
                                    <th data-name="ip" data-type="text" data-op="cn" style="min-width:80px;">IP</th>
                                    <th data-name="service" data-type="text" data-op="cn" style="min-width:60px;">Service</th>
                                    ...
                                    <th data-name="sub_id" data-type="text" data-op="cn" style="min-width:60px;">SUBID</th>
                                    <th data-name="page" data-type="text" data-op="cn">PAGE</th>
                                    <th data-name="content" data-type="text" data-op="cn">TXT</th>
                                    <th data-name="country_code" data-type="text" data-op="eq" style="min-width:50px;">Country</th>
                                </tr>
                            </thead>
                        </table>
...
$(document).ready(function() {
    ...
    var table = $('#data-table').DataTable({
        ...
        "ajax": {
            "url": "/<?=SHOP_INFO_ADMIN_DIR?>/logs/admin",
            "type": "POST",
            "dataType": "JSON",
            "data": {
                "mode": "list",
