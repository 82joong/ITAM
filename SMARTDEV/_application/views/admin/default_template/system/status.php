            ...
            <div class="panel">
                <div class="panel-hdr">
                    ...
                    <div class="panel-toolbar">
                        <a href="/<?=SHOP_INFO_ADMIN_DIR?>/system/status_detail" class="btn btn-sm btn-success waves-effect waves-themed">
                    ...
                    <div class="panel-content">
                        ...
                        <table id="data-table" class="table table-sm table-striped table-bordered table-hover" style="width:100%">
                            <thead class="bg-warning-200">
                                <tr>
                                    <th data-name="s_id" data-type="text" data-op="eq">ID</th>
                                    <th data-name="s_name" data-type="text" data-op="cn">Name</th>
                                    <th data-name="s_code" data-type="text" data-op="eq">Code</th>
                                    <th data-name="s_color_code" data-type="text" data-op="eq">Color</th>
                                    <th data-name="s_description" data-type="text" data-op="cn">Description</th>
                                    <th data-name="s_is_active" data-type="select" data-value="<?=$active_data?>" data-op="eq">IsActive</th>
                                    <th data-name="s_show_nav" data-type="select" data-value="<?=$nav_data?>" data-op="eq">ShowNav</th>
...
$(document).ready(function() {
    ...
    var table = $('#data-table').DataTable({
        ...
        "ajax": {
            "url": "/<?=SHOP_INFO_ADMIN_DIR?>/system/status",
            "type": "POST",
            "dataType": "JSON",
            "data": {
                "mode": "list",
        ...
        "columnDefs": [
            { "className": "text-center fs-nano", "targets": [0,1,2,3,5,6,7] },
            { "className": "text-left fs-nano", "targets": 4 },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    var btn_act = ''; 
                    var base_url = '/<?=SHOP_INFO_ADMIN_DIR?>/system/status_detail';

                    // Edit/Detail 
                    btn_act += dtEditButton(base_url+'/'+data.s_id);
