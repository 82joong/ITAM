                ...
                <aside class="page-sidebar">
                    <div class="page-logo">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            <img src="<?=$assets_dir?>/img/<?=LOGO?>" alt="SmartAdmin WebApp" aria-roledescription="logo" style="width:38px;">
					...
					<?php
						...
						foreach ($page_nav as $key => $nav_item) {
                            /* TODO. Level 
							if($sess_data['admin']['level'] < $nav_item['level']) {
								continue;
							}
                            */
							//process parent nav
							...
							$icon = isset($nav_item["icon"]) ? '<i class="fal '.$nav_item["icon"].'"></i>' : "";
							$nav_title = isset($nav_item["title"]) ? $nav_item["title"] : "(No Name)";

                            $nav_i18n = $i18n.'.'.$key; 

							$nav_htm .= '<a href="'.$url.'" '.$url_target.' title="'.$nav_title.'">';
                            $nav_htm .= $icon;
                            $nav_htm .= ' <span class="nav-link-text" data-i18n="'.$nav_i18n.'">'.$nav_title.'</span></a>';


                            $open = '';
							if (isset($nav_item["sub"]) && $nav_item["sub"]) {
								$nav_htm .= process_sub_nav($nav_item["sub"], $nav_i18n);
                                $open = 'open';
                            }

							echo '<li '.(isset($nav_item["active"]) ? 'class = "active '.$open.'"' : '').'>'.$nav_htm.'</li>';
						}

						function process_sub_nav($nav_item, $i18n) {
							$sub_item_htm = "";
							if (isset($nav_item["sub"]) && $nav_item["sub"]) {
								$sub_nav_item = $nav_item["sub"];
								$sub_item_htm = process_sub_nav($sub_nav_item, $i18n);
							} else {
								$sub_item_htm .= '<ul>';
								foreach ($nav_item as $key => $sub_item) {
									...
									$icon = isset($sub_item["icon"]) ? '<i class="fal '.$sub_item["icon"].'"></i>' : "";
                                    ...
                                    $count = "";
                                    if(isset($sub_item['count'])) {
                                        $count = '<span class="dl-ref label bg-primary-500 ml-2">'.number_format($sub_item['count']).'</span>';
                                    }
									...
									$sub_item_htm .= 
										'<li '.(isset($sub_item["active"]) ? 'class = "active '.$open.'"' : '').'>
											<a href="'.$url.'" '.$url_target.'>'.$icon.' 
                                                <span class="nav-link-text"  data-i18n="'.$sub_i18n.'">'.$nav_title.'</span>
                                                '.$count.'
                                            </a>
											'.(isset($sub_item["sub"]) ? process_sub_nav($sub_item["sub"], $sub_i18n) : '').'
										</li>';
								}
								$sub_item_htm .= '</ul>';
							}
                ...
                <div class="page-content-wrapper">
                    ...
                    <header class="page-header" role="banner">
                        ...
                        <div class="ml-auto d-flex">
                                            ...
                                            <div class="custom-scroll h-100">
                                                <ul class="notification">
                                                    <li class="unread">
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/shop_assets/img/demo/avatars/avatar-c.png')"></span>
                                                            </span>
                                                    ...
                                                    <li class="unread">
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/shop_assets/img/demo/avatars/avatar-a.png')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/shop_assets/img/demo/avatars/avatar-b.png')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-warning mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/shop_assets/img/demo/avatars/avatar-e.png')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                <!-- </shop_assets/img src="img/demo/avatars/avatar-m.png" data-src="img/demo/avatars/avatar-h.png" class="profile-image rounded-circle" alt="Sarah McBrook" /> -->
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/shop_assets/img/demo/avatars/avatar-h.png')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/shop_assets/img/demo/avatars/avatar-m.png')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-danger mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/shop_assets/img/demo/avatars/avatar-j.png')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                        ...
                                        <div class="tab-pane" id="tab-feeds" role="tabpanel">
                                            <div class="custom-scroll h-100">
                                                <ul class="notification">
                                                        ...
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            <span class="d-flex flex-column flex-1">
                                                                ...
                                                                <span class="msg-a fs-sm">
                                                                    System updated to version <strong>4.4.5</strong> <a href="docs_buildnotes.html">(patch notes)</a>
                                                                </span>
                                                    ...
                                                    <li>
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            <!--</shop_assets/img src="img/demo/avatars/avatar-m.png" data-src="img/demo/avatars/avatar-k.png" class="profile-image rounded-circle" alt="k" />-->
                                                            <div class="d-flex flex-column flex-1">
                                                                <span class="name">
                                                                    Troy Norman'<span class="fw-300">s new connections</span>
                                                                </span>
                                                                <div class="fs-sm d-flex align-items-center mt-2">
                                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('/shop_assets/img/demo/avatars/avatar-a.png'); background-size: cover;"></span>
                                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('/shop_assets/img/demo/avatars/avatar-b.png'); background-size: cover;"></span>
                                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('/shop_assets/img/demo/avatars/avatar-c.png'); background-size: cover;"></span>
                                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('/shop_assets/img/demo/avatars/avatar-e.png'); background-size: cover;"></span>
                                                                    <div data-hasmore="+3" class="rounded-circle profile-image-md mr-1">
                                                                        <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('/shop_assets/img/demo/avatars/avatar-h.png'); background-size: cover;"></span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="d-flex flex-column flex-1">
                                                                ...
                                                                <div class="fs-sm d-flex align-items-center mt-1">
                                                                    <a href="#" class="mr-1 mt-1" title="Cell A-0012">
                                                                        <span class="d-block img-share" style="background-image:url('/shop_assets/img/thumbs/pic-7.png'); background-size: cover;"></span>
                                                                    </a>
                                                                    <a href="#" class="mr-1 mt-1" title="Patient A-473 saliva">
                                                                        <span class="d-block img-share" style="background-image:url('/shop_assets/img/thumbs/pic-8.png'); background-size: cover;"></span>
                                                                    </a>
                                                                    <a href="#" class="mr-1 mt-1" title="Patient A-473 blood cells">
                                                                        <span class="d-block img-share" style="background-image:url('/shop_assets/img/thumbs/pic-11.png'); background-size: cover;"></span>
                                                                    </a>
                                                                    <a href="#" class="mr-1 mt-1" title="Patient A-473 Membrane O.C">
                                                                        <span class="d-block img-share" style="background-image:url('/shop_assets/img/thumbs/pic-12.png'); background-size: cover;"></span>
                                                                    </a>
                                                                </div>
                                                                <span class="fs-nano text-muted mt-1">55 minutes ago</span>
                                                            </div>
                            ...
                            <!-- app user menu -->
                            <div>
                                <a href="#" data-toggle="dropdown" title="<?=$admin_data['login_id']?>" class="header-icon d-flex align-items-center justify-content-center ml-2">
                                    <!--img src="/shop_assets/img/demo/avatars/avatar-admin.png" class="profile-image rounded-circle" alt=""-->
									<span class="ml-1 mr-1 text-truncate-header hidden-xs-down text-warning">
                                        <?php if($_IS_SUPER) : ?>SUPER<?php else: ?>Lv<?=$admin_data['level']?><?php endif; ?>
                                    </span>
									<i class="ni ni-chevron-down hidden-xs-down text-danger"></i>
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <span class="btn btn-lg profile-image btn-danger btn-icon rounded-circle position-relative js-waves-off">
                                                <i class="fal fa-user"></i>
                                                </span>

                                            </span>
                                            <div class="info-card-text">
                                                <div class="fs-lg text-truncate text-truncate-lg"><?=$admin_data['name']?></div>
                                                <span class="text-truncate text-truncate-md opacity-80"><?=$admin_data['login_id']?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="dropdown-multilevel dropdown-multilevel-left">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a href="#?lang=ko" class="dropdown-item" data-action="lang" data-lang="ko">한글</a>
                                    ...
                                    <div class="dropdown-divider m-0"></div>
                                    <a class="dropdown-item fw-500 pt-3 pb-3" href="/<?=SHOP_INFO_ADMIN_DIR?>/main/logout">
                                        <span data-i18n="drpdwn.page-logout">Logout</span>
                                        <span class="float-right fw-n">&commat;<?=$admin_data['login_id']?></span>
                                    </a>
                                </div>
                            </div>
                        </div>
