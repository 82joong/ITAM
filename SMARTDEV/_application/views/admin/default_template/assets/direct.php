                        ...
                        <table id="data-table" class="table table-sm table-striped table-bordered table-hover" style="width:100%">
                            <thead class="bg-warning-200">
                                <tr>
                                    ...
                                    <th data-name="ip_address" data-type="text" data-op="eq">Service IP</th>
                                    <th data-name="remote_ip" data-type="">Remote IP</th>
...
$(document).ready(function() {
    ...
    var table = $('#data-table').DataTable({
        ...
        "ajax": {
            "url": "/<?=SHOP_INFO_ADMIN_DIR?>/assets/direct",
            "type": "POST",
            "dataType": "JSON",
            "data": {
                "mode": "list",
        ...
        "columnDefs": [
            { "className": "text-center fs-nano", "targets": "_all" },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    // View 
                    btn_act += dtViewButton(base_url+'/status_detail/'+data.am_id, '_blank');

                    // Edit/Detail 
                    btn_act += dtEditButton(base_url+'/detail/servers/'+data.am_id+'#tab_ips', '_blank');
