            ...
            <div class="panel">
                <div class="panel-hdr">
                    ...
                    <div class="panel-toolbar">
                        <a href="/<?=SHOP_INFO_ADMIN_DIR?>/assets/detail/<?=$assets_type_uri?>" class="btn btn-sm btn-success waves-effect waves-themed">
                        ...
                        <table id="data-table" class="table table-sm table-striped table-bordered table-hover" style="width:100%">
                            <thead class="bg-warning-200">
                                <tr>
                                    ...
                                    <th data-name="category" data-type="select" data-value="<?=$category_type?>" data-op="en">Category</th>
                                    ...
                                    <?php foreach($ex_fields as $ex) : ?>
                                    <th data-name="<?='ex_'.$ex['cv_name']?>" data-type="text" data-op="cn"><?=$ex['cv_name']?></th>
                                    <?php endforeach; ?>
...
$(document).ready(function() {
    ...
    var table = $('#data-table').DataTable({
        ...
        "ajax": {
            "url": "/<?=SHOP_INFO_ADMIN_DIR?>/assets/type/<?=$assets_type_uri?>",
            "type": "POST",
            "dataType": "JSON",
            "data": {
                "mode": "list",
        ...
        "createdRow": function(row, data, dataIndex){
            ...
            $('td:eq(2),td:eq(11),td:eq(13),td:eq(14)', row).css('min-width', '130px');
        },
        "columns": [
            {"data": "am_id"},
            {"data": "am_company_id"},
