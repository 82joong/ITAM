                        ...
                        <table id="data-table" class="table table-sm table-striped table-bordered table-hover" style="width:100%">
                            <thead class="bg-warning-200">
                                <tr>
                                    ...
                                    <th data-name="from" data-type="text" data-op="cn">From</th>
                                    <th data-name="eventmsg" data-type="text" data-op="cn">EventMsg</th>
                                    <th data-name="userip" data-type="text" data-op="cn">User IP</th>
                                    <th data-name="username" data-type="text" data-op="cn">UserName</th>
                                    <th data-name="groupname" data-type="text" data-op="cn">GroupName</th>
                                    <th data-name="country" data-type="text" data-op="cn">Country</th>
...
$(document).ready(function() {
    ...
    var table = $('#data-table').DataTable({
        ...
        "ajax": {
            "url": "/<?=SHOP_INFO_ADMIN_DIR?>/syslog/radius",
            "type": "POST",
            "dataType": "JSON",
            "data": {
                "mode": "list",
