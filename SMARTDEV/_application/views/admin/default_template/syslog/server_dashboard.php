...
$_ES_DASH_LINK = HTTPS_DASHBOARD_URL."/app/dashboards#/view/9a1a87a0-a03a-11ec-b22c-db079a821bb2?embed=true";
        ...
        <div class="col-xl-12">
            <div class="panel" style="background-color:#101010;">
                <div class="panel-hdr" style="background-color:#101010;">
                    <h2 class="text-success fw-900" >Syslog [es.systemevent-*] Kibana Dashboard</h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <div class="form-row form-group justify-content-md-center">
                            <iframe src="<?=$_ES_DASH_LINK?>" height="3270px" width="100%" frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=no vspace=0></iframe>
