        ...
        <div class="col-xl-12">
            <div class="panel">
                <div class="panel-hdr">
                    ...
                    <!--div class="btn-group">
                        <button class="btn btn-danger btn-sm dropdown-toggle waves-effect waves-themed" type="button" data-toggle="dropdown" aria-expanded="false"> Change interval </button>
                        <div class="dropdown-menu dropdown-lg p-0" style="">
                            <div class="px-4 py-2 d-flex align-items-center justify-content-center">
                                <input type="range" class="custom-range js-set-interval" id="set-interval" min="0" max="60000" step="5000" value="60000">
                            </div>
                        </div>
                    </div-->
                        ...
                        <table id="data-table" class="table table-sm table-striped table-bordered table-hover" style="width:100%">
                            <thead class="bg-warning-200">
                                <tr>
                                    ...
                                    <th data-name="category" data-type="text" data-op="cn">Category</th>
                                    ...
                                    <th data-name="hosturl" data-type="text" data-op="cn">HostUrl</th>
                                    <th data-name="eventmsg" data-type="text" data-op="cn">EventMsg</th>
                                    <th data-name="userip" data-type="text" data-op="cn">UserIP</th>
...
$(document).ready(function() {
    ...
    var table = $('#data-table').DataTable({
        ...
        "ajax": {
            "url": "/<?=SHOP_INFO_ADMIN_DIR?>/syslog/server",
            "type": "POST",
            "dataType": "JSON",
            "data": {
                "mode": "list",
