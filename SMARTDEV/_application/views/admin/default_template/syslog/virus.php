                        ...
                        <table id="data-table" class="table table-sm table-striped table-bordered table-hover" style="width:100%">
                            <thead class="bg-warning-200">
                                <tr>
                                    ...
                                    <th data-name="hostip" data-type="text" data-op="eq">Host IP</th>
                                    ...
                                    <th data-name="region" data-type="text" data-op="cn">Region</th>
                                    <th data-name="filename" data-type="text" data-op="cn">File</th>
...
$(document).ready(function() {
    ...
    var table = $('#data-table').DataTable({
        ...
        "ajax": {
            "url": "/<?=SHOP_INFO_ADMIN_DIR?>/syslog/virus",
            "type": "POST",
            "dataType": "JSON",
            "data": {
                "mode": "list",
